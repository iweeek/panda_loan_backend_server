...
public interface UserMapper {
     ...
     * @mbg.generated  Wed Jan 24 18:30:45 CST 2018
     */
    @Insert({ "insert into user (username, password, ", "regist_time, created_at)",
            "values (#{username,jdbcType=VARCHAR}, #{password,jdbcType=VARCHAR}, ",
            "#{registTime,jdbcType=BIGINT}, #{createdAt,jdbcType=TIMESTAMP})" })
     ...
     * @mbg.generated  Wed Jan 24 18:30:45 CST 2018
     */
    @Select({ "select", "id, username, password, regist_time, created_at", "from user",
    ...
    @Update({ "update user", "set username = #{username,jdbcType=VARCHAR},", "password = #{password,jdbcType=VARCHAR},",
            "regist_time = #{registTime,jdbcType=BIGINT},", "created_at = #{createdAt,jdbcType=TIMESTAMP}",
            "where id = #{id,jdbcType=BIGINT}" })
    ...
    @Select({"SELECT * FROM user where created_at between timestamp(#{startTime}) and timestamp(#{endTime}) "})
    @ResultMap("com.pinganzhiyuan.mapper.UserMapper.BaseResultMap")
	List<User> timeStampCreatedAtBetween(@Param("startTime") Timestamp startTime,@Param("endTime") Timestamp endTime);
