...
public interface DeviceLogMapper {
    ...
    @ResultMap("com.pinganzhiyuan.mapper.DeviceLogMapper.BaseResultMap")
    List<DeviceLog> getGroupByDeviceDataList(@Param("startDate") Date startDate, @Param("endDate") Date endDate);
    ...
    @Select({ "select * from device_log where created_at < date(#{startDate}) group by user_id" })
    @ResultMap("com.pinganzhiyuan.mapper.DeviceLogMapper.BaseResultMap")
    List<DeviceLog> getAllGroupByUserDataList(@Param("startDate") Date startDate);
    ...
    @Select({ "SELECT count(*), device_log.*  from device_log\n" + 
            "where \n" + 
            "created_at between date(#{startDate}) and date(#{endDate})  and p_id is not null\n" + 
            "group by p_id, created_at, uri" })
    @ResultMap("com.pinganzhiyuan.mapper.DeviceLogMapper.BaseResultMap")
    List<DeviceLog> getVisitCountByProductDataList(@Param("startDate") Date startDate, @Param("endDate") Date endDate);
    
    @Select({ "SELECT device_log.*  from device_log\n" + 
            "where \n" + 
            "created_at between date(#{startDate}) and date(#{endDate}) and p_id is not null\n" + 
            "group by p_id, user_id, created_at, uri" })
    @ResultMap("com.pinganzhiyuan.mapper.DeviceLogMapper.BaseResultMap")
    List<DeviceLog> getVisitUserCountByProductDataList(@Param("startDate") Date startDate, @Param("endDate") Date endDate);
