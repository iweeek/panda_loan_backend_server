...
public interface ClientColumnMappingMapper {
     ...
     * This method corresponds to the database table client_column_mapping
     *
     ...
     */
    @Insert({
        "insert into client_column_mapping (package_name, platform_id, ",
        "column_key)",
     ...
     * @mbg.generated Mon Feb 05 09:45:08 CST 2018
     */
    int updateByExampleSelective(@Param("record") ClientColumnMapping record, @Param("example") ClientColumnMappingExample example);
     ...
     * @mbg.generated Mon Feb 05 09:45:08 CST 2018
     */
    int updateByExample(@Param("record") ClientColumnMapping record, @Param("example") ClientColumnMappingExample example);
