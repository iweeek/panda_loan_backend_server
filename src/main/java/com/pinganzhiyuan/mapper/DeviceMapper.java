...
public interface DeviceMapper {
    ...
    @Insert({ "insert into statistic_device (device_id, device_brand, ", "device_system_version, maiden_start_time, ",
            ...
            "channel_name, app_product_id, ", "app_product_name, app_product_package_name, ",
            "app_product_version, is_root, ", "created_at)",
            ...
            "#{appProductName,jdbcType=VARCHAR}, #{appProductPackageName,jdbcType=VARCHAR}, ",
            "#{appProductVersion,jdbcType=VARCHAR}, #{isRoot,jdbcType=BIT}, ", "#{createdAt,jdbcType=TIMESTAMP})" })
    ...
    @Select({ "select", "id, device_id, device_brand, device_system_version, maiden_start_time, maiden_start_ip, ",
            ...
            "app_product_name, app_product_package_name, app_product_version, is_root, created_at",
            "from statistic_device", "where id = #{id,jdbcType=BIGINT}" })
    ...
    @Update({ "update statistic_device", "set device_id = #{deviceId,jdbcType=VARCHAR},",
            ...
            "app_product_package_name = #{appProductPackageName,jdbcType=VARCHAR},",
