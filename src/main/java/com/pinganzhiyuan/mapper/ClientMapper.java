...
public interface ClientMapper {
    ...
    @Insert({ "insert into client (user_id, name, ", "identity_no, residence_addr, ", "is_man, nation, birthday, ",
            "identity_auth, identity_expiration, ", "education, guarantee, ", "profession, created_at)",
            ...
            "#{education,jdbcType=VARCHAR}, #{guarantee,jdbcType=VARCHAR}, ",
            "#{profession,jdbcType=VARCHAR}, #{createdAt,jdbcType=TIMESTAMP})" })
    ...
    @Select({ "select", "id, user_id, name, identity_no, residence_addr, is_man, nation, birthday, identity_auth, ",
            "identity_expiration, education, guarantee, profession, created_at", "from client",
